...
Найдите все ошибки в этой программе (их ровно 222). Известно, что каждая ошибка затрагивает только одну строку и может быть исправлена без изменения других строк.
'''
